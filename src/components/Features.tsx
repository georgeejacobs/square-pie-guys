...
export default function Features() {
  return (
    ...
    bright" data-animation="none" id="yui_3_17_2_1_1771524214245_150">
      ...
      <div className="content-wrapper" style={{
        ...
        }} id="yui_3_17_2_1_1771524214245_149">
        <div className="content" id="yui_3_17_2_1_1771524214245_148">
          ...
          <div id="yui_3_17_2_1_1771524214245_147">
            
            <div className="fluid-engine fe-65a1c9d0ac1b343be05159cc" id="yui_3_17_2_1_1771524214245_146">
              <div className="fe-block fe-block-7b816d4d13531865e314" id="yui_3_17_2_1_1771524214245_145">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-aspect-ratio="117.61126270797615" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-7b816d4d13531865e314">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771524214245_144" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default" data-component-id="7b816d4d13531865e314" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="true" data-is-mask-applied="false" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771524214245_143">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771524214245_142">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{ overflow: 'hidden', WebkitMaskImage: '-webkit-radial-gradient(white, black)' }} data-sqsp-image-block-image-container="" id="yui_3_17_2_1_1771524214245_141">
                          <div className="js-content-mode-element content-fill" id="yui_3_17_2_1_1771524214245_137">
                            <Image 
                              data-stretch="true" 
                              crossOrigin="" 
                              src="/image-1.webp"
                ...
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-button button-block" data-block-type="1337" data-definition-name="website.components.button" data-sqsp-block="button" id="block-3051c7258fdf7da45539">
                  <div className="sqs-block-content">
                    <div className="sqs-block-button-container sqs-block-button-container--center" data-animation-role="button" data-alignment="center" data-button-size="medium" data-button-type="primary">
                      <a className="sqs-block-button-element--medium sqs-button-element--primary sqs-block-button-element" href="https://www.goldbelly.com/the-single-pebble/monday-big-box-deal?ref=merchant" data-initialized="true" target="_blank" rel="noopener">ORDER NOW</a>
                    </div>
                  </div>
                </div>
              </div>

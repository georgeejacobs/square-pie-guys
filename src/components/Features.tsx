...
export default function Features() {
  return (
    ...
    white" data-animation="none" id="yui_3_17_2_1_1771522505598_166">
      ...
      <div className="content-wrapper" style={{}} id="yui_3_17_2_1_1771522505598_165">
        <div className="content" id="yui_3_17_2_1_1771522505598_164">
          <div id="yui_3_17_2_1_1771522505598_163">
            <style jsx>{`
            ...
            `}</style>
            <div className="fluid-engine fe-6585f6588bffa766875dc1be" id="yui_3_17_2_1_1771522505598_162">
              <div className="fe-block fe-block-yui_3_17_2_1_1705085365777_87191" id="yui_3_17_2_1_1771522505598_161">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-aspect-ratio="100" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-yui_3_17_2_1_1705085365777_87191">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771522505598_160" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default" data-component-id="yui_3_17_2_1_1705085365777_87191" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="true" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771522505598_159">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771522505598_158">
                        <div className="fluid-image-container sqs-image-content js-image-container" data-shape-mask="eight-sided-shield" style={{ overflow: 'hidden', clipPath: 'url("#yui_3_17_2_1_1705085365777_87191")', width: '100%', height: '657px' }} data-sqsp-image-block-image-container="" id="yui_3_17_2_1_1771522505598_157">
                          <div className="js-content-mode-element content-fill" id="yui_3_17_2_1_1771522505598_154">
                            <Image 
                              data-stretch="false" 
              ...
              <div className="fe-block fe-block-yui_3_17_2_1_1705085365777_95078">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-button button-block sqs-text-ready" data-aspect-ratio="NaN" data-block-type="1337" data-definition-name="website.components.button" data-sqsp-block="button" id="block-yui_3_17_2_1_1705085365777_95078">
                    ...
                    <div className="button-component-root">
                      <div className="button-layout-wrapper">
                        <div className="button-alignment-wrapper">
                          <a className="sqs-button-element--primary sqs-button-element" href="#" target="">

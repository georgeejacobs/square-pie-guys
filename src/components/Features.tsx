...
export default function Features() {
  return (
    ...
    black-bold" data-animation="none" data-fluid-engine-section="">
    ...
    <Image alt="" data-image-focal-point="0.5,0.5" crossOrigin="" data-src="/image-0.png" data-image="/image-0.png" data-image-dimensions="2220x1644" data-load="false" src="/image-0.png" width={2220} height={1644} sizes="(max-width: 799px) 200vw, 100vw" className="background-image-fx" style={{ display: 'block', objectPosition: '50% 50%', visibility: 'visible' }} srcSet="/image-0.png?format=100w 100w, /image-0.png?format=300w 300w, /image-0.png?format=500w 500w, /image-0.png?format=750w 750w, /image-0.png?format=1000w 1000w, /image-0.png?format=1500w 1500w, /image-0.png?format=2500w 2500w" loading="lazy" decoding="async" data-loader="sqs" />
            ...
            <div className="fluid-engine fe-697f96a8134cbc609c3273d3">
              ...
              <div className="fe-block fe-block-ae2cfd5144aff2bb1d2c">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-button button-block" data-block-type="1337" data-definition-name="website.components.button" data-sqsp-block="button" id="block-ae2cfd5144aff2bb1d2c">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771488503913_222">

                    <div className="sqs-block-button-container  sqs-block-button-container--center sqs-stretched" data-animation-role="button" data-button-size="medium" data-button-type="primary" id="yui_3_17_2_1_1771488503913_221"> 
...
#block-ae2cfd5144aff2bb1d2c {--sqs-block-content-flex: 1;
                      }
`}</style>
</section>
  )

...
export default function CallToAction() {
  return (
    <section data-test="page-section" data-section-theme="white" className="page-section full-bleed-section layout-engine-section background-width--full-bleed section-height--medium content-width--wide horizontal-alignment--center vertical-alignment--middle has-background white" data-animation="none" data-fluid-engine-section="" id="yui_3_17_2_1_1771517851052_205">
      ...
      <div className="content-wrapper" id="yui_3_17_2_1_1771517851052_204">
        <div className="content" id="yui_3_17_2_1_1771517851052_203">
          <div data-fluid-engine="true" id="yui_3_17_2_1_1771517851052_202">
            <style jsx>{`
            ...
            `}</style>
            <div className="fluid-engine fe-6596f6510337c27da4828ba5" id="yui_3_17_2_1_1771517851052_201">
              <div className="fe-block fe-block-1ef399867fe80a1a9b64" id="yui_3_17_2_1_1771517851052_200">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-aspect-ratio="100" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-1ef399867fe80a1a9b64">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771517851052_199" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default" data-component-id="1ef399867fe80a1a9b64" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="true" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771517851052_198">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771517851052_197">
                        <div className="fluid-image-container sqs-image-content js-image-container" data-shape-mask="eight-sided-shield" style={{ overflow: 'hidden', clipPath: 'url("#1ef399867fe80a1a9b64")', width: '100%', height: '657px' }} id="yui_3_17_2_1_1771517851052_196">
                          <div className="js-content-mode-element content-fill" id="yui_3_17_2_1_1771517851052_193">
                            <img 
                              data-stretch="false" 
              ...
              <div className="fe-block fe-block-yui_3_17_2_1_1706211787573_32812">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-button button-block" data-block-type="1341" data-definition-name="website.components.button" data-sqsp-block="button" id="block-yui_3_17_2_1_1706211787573_32812">
                  <div className="sqs-block-content">
                    <div className="sqs-block-button-container sqs-block-button-container--center" data-animation-role="button" data-alignment="center" data-button-size="medium" data-button-type="secondary">
                      <a className="sqs-block-button-element--medium sqs-button-element--secondary sqs-block-button-element" href="https://squareup.com/gift/MLGM7W3DGQGR5/order" data-sqsp-button-element="" data-initialized="true">
                        BUY A GIFT CARD
                      </a>
                    </div>
                  </div>

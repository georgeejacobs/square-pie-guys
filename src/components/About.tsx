...
export default function About() {
  return (
    ...
    <Image alt="" crossOrigin="anonymous" src="/image-0.png" width={2220} height={1644} sizes="(max-width: 799px) 200vw, 100vw" className="background-image-fx" style={{ display: 'block', objectPosition: '50% 50%', visibility: 'visible' } as any} loading="lazy" decoding="async" />

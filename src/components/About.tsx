      ...
      <div className="section-border">
        <div className="section-background">
          <div className="section-background-content">
            <img alt="" data-image-focal-point="0.5,0.5" crossOrigin="" data-src="/image-0.webp" data-image="/image-0.webp" data-image-dimensions="2220x1644" data-load="false" src="/image-0.webp" width="2220" height="1644" sizes="(max-width: 799px) 200vw, 100vw" className="background-image-fx" style={{ display: 'block', objectPosition: '50% 50%', visibility: 'visible' }} srcSet="/image-0.webp?format=100w 100w, /image-0.webp?format=300w 300w, /image-0.webp?format=500w 500w, /image-0.webp?format=750w 750w, /image-0.webp?format=1000w 1000w, /image-0.webp?format=1500w 1500w, /image-0.webp?format=2500w 2500w" loading="lazy" decoding="async" data-loader="sqs" />

...
export default function PromoBanner() {
  return (
    <header data-test="header" id="header" className="white header theme-col--primary" data-section-theme="white" data-header-style="solid" tabIndex={-1} style={{}} >
      ...
      <div className="sqs-announcement-bar-dropzone">
        <div className="sqs-announcement-bar-custom-location">
          <div id="yui_3_17_2_1_1771614840784_284" className="yui3-widget sqs-widget sqs-announcement-bar">
            <div id="yui_3_17_2_1_1771614840784_286" className="sqs-announcement-bar-content">
          ...
          <div className="header-display-desktop" data-content-field="site-title">
                    ...
                    <div className="header-title" data-animation-role="header-element">
                        ...
                        <div className="header-title-logo">
                          <a href="/" data-animation-role="header-element">
                            ...
                            <Image src="/image-7.webp" alt="Square Pie Guys" style={{display:'block'}} loading="eager" decoding="async" width={1500} height={500} />
              ...
              <div className="header-actions header-actions--right">
                    ...
                    <div className="header-actions-action header-actions-action--cta">
                        ...
                        <a href="https://opnl.co/squarepieguys-app" className="btn btn--border" data-animation-role="header-element">
                          Order Online
                        </a>
                ...
                <div className="header-actions-action header-actions-action--cart">
                  <a href="/cart" className="cart-icon-link" aria-label="View Cart" data-animation-role="header-element">
                    
                    <div className="icon icon--stroke cart-icon sqs-svg-icon--list" data-use-textmask="" aria-hidden="true">
                      <div className="icon-list" data-animation-role="header-element">
                        <svg className="icon icon--cart_simple sqs-svg-icon--list" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                          <g clipPath="url(#clip0)" fill="none" stroke="currentColor">
                            <path d="M6.5 9H18.5L17 15.5H8L6.5 9Z" />
                            <path d="M6 6.5L3 2" />

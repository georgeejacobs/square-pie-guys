    ...
    <header data-test="header" id="header" className="white header theme-col--primary" data-section-theme="white" data-header-style="solid" data-first-focusable-element="" tabIndex={-1}>
      ...
      <div className="sqs-announcement-bar-dropzone">
        <div className="sqs-announcement-bar-custom-location">
          <div id="yui_3_17_2_1_1771485672319_284" className="yui3-widget sqs-widget sqs-announcement-bar">
            <div id="yui_3_17_2_1_1771485672319_286" className="sqs-announcement-bar-content">
            ...
            <div className="header-actions header-actions--right">
                    ...
                    <div className="header-actions-action header-actions-action--cart">
                      <a className="Cart-inner" href="/cart">
                        <div className="sqs-cart-quantity" aria-label="Shopping Cart">
                          <span className="sqs-cart-quantity-indicator"></span>
                          <span className="sqs-cart-quantity-indicator-number" tabIndex={0}></span>
                        </div>
                      </a>
                    </div>

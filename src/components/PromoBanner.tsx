...
export default function PromoBanner() {
  return (
    <header data-test="header" id="header" className="white header theme-col--primary" data-section-theme="white" tabIndex={-1} style={{}} data-first-focusable-element="">
      ...
      <div className="sqs-announcement-bar-dropzone"><div className="sqs-announcement-bar-custom-location"><div id="yui_3_17_2_1_1771485953910_284" className="yui3-widget sqs-widget sqs-announcement-bar"><div id="yui_3_17_2_1_1771485953910_286" className="sqs-announcement-bar-content"><a className="sqs-announcement-bar-url" target="_blank" href="https://opnl.co/squarepieguys-app" aria-labelledby="announcement-bar-text-inner-id"></a>
      ...
      <div className="sqs-announcement-bar-text">
        ...
        <div id="announcement-bar-text-inner-id" className="sqs-announcement-bar-text-inner">
          <p data-rte-preserve-empty="true" style={{whiteSpace:'pre-wrap'}}><strong>$29 OG Bundle Deal is Here!</strong></p><p data-rte-preserve-empty="true" style={{whiteSpace:'pre-wrap'}}><em>1 pep + 1 cheese pizza = $29</em></p><p data-rte-preserve-empty="true" style={{whiteSpace:'pre-wrap'}}><strong>Order Here!</strong></p>
        </div>
      </div></div></div></div></div>

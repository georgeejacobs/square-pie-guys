...
export default function Features2() {
  return (
    <section data-test="page-section" data-section-theme="bright" className="page-section has-section-divider full-bleed-section layout-engine-section background-width--full-bleed section-height--medium content-width--wide horizontal-alignment--center vertical-alignment--middle bright" data-animation="none" data-fluid-engine-section="" id="yui_3_17_2_1_1771517685963_180">
      <style jsx>{`
      ...
      <div className="content-wrapper" id="yui_3_17_2_1_1771517685963_179">
        <div className="content" id="yui_3_17_2_1_1771517685963_178">
          <div data-fluid-engine="true" id="yui_3_17_2_1_1771517685963_177">
            <div className="fluid-engine fe-658f2bce80842075444608ae" id="yui_3_17_2_1_1771517685963_176">
              <div className="fe-block fe-block-41bcbba421979d3ae030" id="yui_3_17_2_1_1771517685963_175">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-41bcbba421979d3ae030">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771517685963_174" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default" data-component-id="41bcbba421979d3ae030" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771517685963_173">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771517685963_172">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{ overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', width: '100%', height: '524.081px' }} data-sqsp-image-block-image-container="" id="yui_3_17_2_1_1771517685963_171">
                          <div className="js-content-mode-element content-fit" id="yui_3_17_2_1_1771517685963_170">
                            <img 
                              data-stretch="false" 
              ...
              <div className="fe-block fe-block-f7a4c0cfa5d9377898d0" id="yui_3_17_2_1_1771517685963_189">
                  ...
                  <div className="sqs-block-content" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default" data-component-id="f7a4c0cfa5d9377898d0" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{ overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', width: '100%', height: '222.205px' }} data-sqsp-image-block-image-container="">
                          <div className="js-content-mode-element content-fit">
                            <img 
                              data-stretch="false" 
                              data-src="/image-7.webp" 
                              data-image="/image-7.webp" 
                              data-image-dimensions="1125x375" 
                              data-image-focal-point="0.5,0.5" 
                              data-sqsp-image-block-image="" 
                              alt="" 
                              data-licensed-asset-preview="false" 
              ...
              <div className="fe-block fe-block-yui_3_17_2_1_1704391605064_26992">
                <div className="sqs-block html-block sqs-block-html" data-block-type="2" data-sqsp-block="text" id="block-yui_3_17_2_1_1704391605064_26992">
                  <div className="sqs-block-content">
                    <div className="sqs-html-content">
                      <p className="" style={{ fontSize: '32px', lineHeight: '1.2em', color: '#313632', whiteSpace: 'pre-wrap' }}>
                        Santa Paula's first collaborative sports bar, featuring the same mouthwatering, quality cuisine from the kitchen of one of Ventura County's favorite restaurants.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="fe-block fe-block-yui_3_17_2_1_1703881549797_13556">
                <div className="sqs-block button-block sqs-block-button" data-block-type="53" id="block-yui_3_17_2_1_1703881549797_13556">
                  <div className="sqs-block-content">
                    <div className="sqs-block-button-container sqs-block-button-container--center" data-animation-role="button" data-alignment="center" data-button-size="small">
                      <a href="/menu" className="sqs-block-button-element--small sqs-button-element--primary sqs-block-button-element" data-initialized="true">
                        VIEW MENU
                      </a>
                    </div>
                  </div>

                  ...
                  <div className="sqs-block-content">
                    <div className="Marquee" style={{ fontSize: '1.2rem', '--marquee-font-size-value': 1.2 } as any} data-ready="true">
                      <div className="Marquee-content" aria-hidden="true">
                        <span className="Marquee-item" data-item-index="0">YOU SAY PIZZA</span>
                        <span className="Marquee-item" data-item-index="1">🍕</span>
                        <span className="Marquee-item" data-item-index="2">WE SAY PIE</span>
                        <span className="Marquee-item" data-item-index="3">🍕</span>
                        <span className="Marquee-item" data-item-index="4">IT'S ALL YUM</span>
                        <span className="Marquee-item" data-item-index="5">🍕</span>
                      </div>
                    </div>
                  </div>
                </div>

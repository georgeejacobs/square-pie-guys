...
export default function NavBar() {
  return (
    ...
    bright" data-animation="none" id="yui_3_17_2_1_1771522834917_150">
      ...
      <div className="content-wrapper" style={{
        ...
        }} id="yui_3_17_2_1_1771522834917_149">
        <div className="content" id="yui_3_17_2_1_1771522834917_148">
          ...
          <div id="yui_3_17_2_1_1771522834917_147">
            <style jsx>{`
            ...
            `}</style>
            <div className="fluid-engine fe-65a1c9d0ac1b343be05159cc" id="yui_3_17_2_1_1771522834917_146">
              <div className="fe-block fe-block-7b816d4d13531865e314" id="yui_3_17_2_1_1771522834917_145">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-aspect-ratio="117.61126270797615" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-7b816d4d13531865e314">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771522834917_144" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default" data-component-id="7b816d4d13531865e314" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="true" data-is-mask-applied="false" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771522834917_143">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771522834917_142">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{ overflow: 'hidden', WebkitMaskImage: '-webkit-radial-gradient(white, black)' }} id="yui_3_17_2_1_1771522834917_141">
                          <div className="js-content-mode-element content-fill" id="yui_3_17_2_1_1771522834917_137">
                            <Image 
                              data-stretch="true" 
                              crossOrigin="" 
                              src="/image-1.jpg" 
              ...
              <div className="fe-block fe-block-3051c7258fdf7da45539">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-button button-block" data-block-type="1337" data-definition-name="website.components.button" data-sqsp-block="button" id="block-3051c7258fdf7da45539">
                  <div className="sqs-block-content">
                    <div className="sqs-button-element--primary sqs-block-button-element" id="yui_3_17_2_1_1771522834917_151">
                      <a className="sqs-block-button-link" href="https://www.grubhub.com/restaurant/slice-of-philly-gourmet-1800-shiloh-rd-tyler-tx-75703/7193913?utm_source=grubhub&utm_medium=content_owned&utm_campaign=menushare&utm_content=share-link" target="_blank" rel="noopener">
                        ORDER NOW
                      </a>
                    </div>
                  </div>

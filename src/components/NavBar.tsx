...
export default function NavBar() {
  return (
    <section data-test="page-section" data-section-theme="bright" className="page-section has-section-divider full-bleed-section layout-engine-section background-width--full-bleed section-height--custom content-width--wide horizontal-alignment--center vertical-alignment--middle bright" data-animation="none" style={{ minHeight: '1vh', paddingTop: '161.5px' } as any} data-active="true">
      <div className="section-border" style={{ clipPath: 'url(#section-divider-6930bd19e0cd98208c29ff2e)' }}>
        <div className="section-background">
        </div>
      </div>
      <div className="content-wrapper" style={{ paddingTop: 'calc(1vmax / 10)', paddingBottom: 'calc(1vmax / 10)' } as any}>
                        ...
                        <h1 style={{ fontSize: '1.2rem', '--marquee-font-size-value': 1.2 } as any}>
                          <svg className="Marquee-svg" fill="currentColor" aria-hidden="true" style={{ height: '26px', transform: 'translateY(2.6px)', overflow: 'visible' }}>
                            <g className="Marquee-path-group" transform="translate(0, 1.3)">
                              <path className="Marquee-path" fill="none" stroke="transparent" strokeWidth="0" d="M-550,17.212  L-550,17.212 S-183.15,17.212 0,17.212 S366.85,17.212 550,17.212 S916.85,17.212 1100,17.212 S1466.85,17.212 1650,17.212 S2016.85,17.212 2200,17.212" strokeDasharray="99 9.228 21 9.228 77 9.228 21 9.228 89 9.228 21 9.228 " id="4ec6f7970b0f5f240202" strokeDashoffset="46" />
                            </g>
                            <text>
                              <textPath className="Marquee-svg-text" href="#4ec6f7970b0f5f240202" startOffset="-46">
                                ...
                                <tspan className="Marquee-svg-text" x="224.68399999999997" style={{ display: 'none' }}>🍕</tspan>
                                <tspan className="Marquee-svg-text" x="254.91199999999998" style={{ display: 'none' }}>IT'S ALL YUM</tspan>
                                ...
                                <tspan className="Marquee-svg-text" x="2822.032000000001" style={{ display: 'none' }}>WE SAY PIE</tspan>
                                <tspan className="Marquee-svg-text" x="2908.260000000001" style={{ display: 'none' }}>🍕</tspan>
                                <tspan className="Marquee-svg-text" x="2938.488000000001" style={{ display: 'none' }}>IT'S ALL YUM</tspan>
                                <tspan className="Marquee-svg-text" x="3036.7160000000013" style={{ display: 'none' }}>🍕</tspan>
                                <tspan className="Marquee-svg-text" x="3066.9440000000013" style={{ display: 'none' }}>YOU SAY PIZZA</tspan>
                                <tspan className="Marquee-svg-text" x="3175.1720000000014" style={{ display: 'none' }}>🍕</tspan>
                                <tspan className="Marquee-svg-text" x="3205.4000000000015" style={{ display: 'none' }}>WE SAY PIE</tspan>
                                <tspan className="Marquee-svg-text" x="3291.6280000000015" style={{ display: 'none' }}>🍕</tspan>
                                <tspan className="Marquee-svg-text" x="3321.8560000000016" style={{ display: 'none' }}>IT'S ALL YUM</tspan>
                                <tspan className="Marquee-svg-text" x="3420.0840000000017" style={{ display: 'none' }}>🍕</tspan>
                              </textPath>
                            </text>
                            <text>

...
export default function Hero() {
  return (
    ...
    bright" data-animation="none" id="yui_3_17_2_1_1771523609099_100" data-active="true">
      ...
      <div className="content-wrapper" style={{
        ...
        }} id="yui_3_17_2_1_1771523609099_99">
        <div className="content" id="yui_3_17_2_1_1771523609099_98">
          ...
          <div id="yui_3_17_2_1_1771523609099_97">
            <style jsx>{`
            ...
            `}</style>
            <div className="fluid-engine fe-698a0a3e60fce413c1f376a0" id="yui_3_17_2_1_1771523609099_96">
              ...
              <div className="fe-block fe-block-b9aa47891e245e329759" id="yui_3_17_2_1_1771523609099_95">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-b9aa47891e245e329759">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771523609099_94" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default sqs-narrow-width animation-loaded" data-component-id="b9aa47891e245e329759" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771523609099_93">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771523609099_92">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{ overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', height: '100%', width: '228px' }} data-sqsp-image-block-image-container="" id="yui_3_17_2_1_1771523609099_91">
                          <div className="js-content-mode-element content-fit" id="yui_3_17_2_1_1771523609099_90">
                            <Image 
                              data-stretch="false" 
                              data-src="/image-10.png" 
                              data-image="/image-10.png" 
              ...
              <div className="fe-block fe-block-a705943738e3a5a1af83" id="yui_3_17_2_1_1771523609099_110">
                  ...
                  <div className="sqs-block-content" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default sqs-narrow-width animation-loaded" data-component-id="a705943738e3a5a1af83" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{ overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', height: '100%', width: '367px' }} data-sqsp-image-block-image-container="">
                          <div className="js-content-mode-element content-fit">
                            <Image 
                              data-stretch="false" 
                              data-src="/image-11.png" 
                              data-image="/image-11.png" 
                              data-image-dimensions="500x500" 
                              data-image-focal-point="0.5,0.5" 
                              data-sqsp-image-block-image="" 
                              alt="" 
                              ...
                              width={500} 
                              height={500} 
                              sizes="(max-width: 640px) 100vw, (max-width: 767px) 100vw, 33.333333333333336vw" 
                              style={{ display: 'block', objectPosition: 'var(--image-component-focal-point)' as any, objectFit: 'var(--image-component-object-fit)' as any } as any} 
                              loading="lazy" 
                            />
                            <div className="fluidImageOverlay"></div>
              ...
              <div className="fe-block fe-block-97a7dc9199a5474f666d">
                <div className="sqs-block button-block sqs-block-button" data-block-type="53" id="block-97a7dc9199a5474f666d">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771523609099_89">
                    <div className="sqs-block-button-container sqs-block-button-container--center" data-animation-role="button" data-alignment="center" data-button-size="medium" data-button-type="primary">
                      <a href="https://direct.chownow.com/order/33633/locations/49108" target="_blank" className="sqs-block-button-element--medium sqs-button-element--primary sqs-block-button-element" data-initialized="true" rel="noopener noreferrer">VIEW MENU</a>
                    </div>
                  </div>
                </div>
              </div>

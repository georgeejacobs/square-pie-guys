...
export default function Hero() {
  return (
    <section data-test="page-section" data-section-theme="bright" className="page-section full-bleed-section layout-engine-section background-width--full-bleed section-height--custom content-width--wide horizontal-alignment--center vertical-alignment--middle bright" data-animation="none" id="yui_3_17_2_1_1771524214245_100" data-active="true">
      <div className="section-border">
        <div className="section-background">
        </div>
      </div>
      <div className="content-wrapper" style={{ paddingTop: 'calc(0vmax / 10)', paddingBottom: 'calc(0vmax / 10)' }} id="yui_3_17_2_1_1771524214245_99">
        <div className="content" id="yui_3_17_2_1_1771524214245_98">
          <div id="yui_3_17_2_1_1771524214245_97">
            
            <div className="fluid-engine fe-698a0a3e60fce413c1f376a0" id="yui_3_17_2_1_1771524214245_96">
              ...
              <div className="fe-block fe-block-b9aa47891e245e329759" id="yui_3_17_2_1_1771524214245_95">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-b9aa47891e245e329759">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771524214245_94" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default sqs-narrow-width animation-loaded" data-component-id="b9aa47891e245e329759" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771524214245_93">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771524214245_92">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{ overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', height: '100%', width: '228px' }} data-sqsp-image-block-image-container="" id="yui_3_17_2_1_1771524214245_91">
                          <div className="js-content-mode-element content-fit" id="yui_3_17_2_1_1771524214245_90">
                            <Image 
                              src="/image-10.webp"
                              alt=""
                              width={500}
              ...
              <div className="fe-block fe-block-a705943738e3a5a1af83" id="yui_3_17_2_1_1771524214245_110">
                  ...
                  <div className="sqs-block-content" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default sqs-narrow-width animation-loaded" data-component-id="a705943738e3a5a1af83" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{ overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', height: '100%', width: '307px' }} data-sqsp-image-block-image-container="">
                          <div className="js-content-mode-element content-fit">
                            <Image 
                              ...
                              width={500}
                              height={500}
                              sizes="(max-width: 640px) 100vw, (max-width: 767px) 33.33vw, 20.83vw"
                              style={{ 
                                display: 'block',
                                objectPosition: 'var(--image-component-focal-point)' as any,
                                objectFit: 'var(--image-component-object-fit)' as any

...
export default function Hero() {
  return (
    ...
    bright" data-animation="none" data-fluid-engine-section="" id="yui_3_17_2_1_1771487219329_100" data-active="true">
      ...
      <div className="content-wrapper" style={{
        ...
        }} id="yui_3_17_2_1_1771487219329_99">
        <div className="content" id="yui_3_17_2_1_1771487219329_98">
          ...
          <div data-fluid-engine="true" id="yui_3_17_2_1_1771487219329_97">
            <style jsx>{`
  ...
  @media (min-width: 768px) {
    ...
    .fe-block-97a7dc9199a5474f666d .sqs-block-alignment-wrapper {
      align-items: center;
            ...
            `}</style>
            <div className="fluid-engine fe-698a0a3e60fce413c1f376a0" id="yui_3_17_2_1_1771487219329_96">
              ...
              <div className="fe-block fe-block-c0ad296aeae3862dfb63" style={{ mixBlendMode: 'normal' }}>
                <div className="sqs-block html-block sqs-block-html" data-blend-mode="NORMAL" data-block-type="2" data-sqsp-block="text" id="block-c0ad296aeae3862dfb63">
                  <div className="sqs-block-content">
                    ...
                    <div className="sqs-html-content" data-sqsp-text-block-content="">
                      <p className="" style={{ whiteSpace: 'pre-wrap' }}><strong>You didn't come here just to come here — it's time to order some pizza </strong>😌.</p><p className="" style={{ whiteSpace: 'pre-wrap' }}>Support local and order directly from us for better pricing, better pizza, and more of what you love!</p>
                    </div>

                  </div>
                </div>
              </div>
              <div className="fe-block fe-block-b9aa47891e245e329759" id="yui_3_17_2_1_1771487219329_95">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-b9aa47891e245e329759">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771487219329_94" style={{ height: '100%', width: '100%' }}>

                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default sqs-narrow-width animation-loaded" data-component-id="b9aa47891e245e329759" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771487219329_93">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771487219329_92">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{ overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', height: '100%', width: '228px' }} data-sqsp-image-block-image-container="" id="yui_3_17_2_1_1771487219329_91">

                          <div className="js-content-mode-element content-fit" id="yui_3_17_2_1_1771487219329_90">
                            
                            <Image src="/image-10.webp" alt="" width={500} height={500} sizes="(max-width: 640px) 100vw, (max-width: 767px) 62.5vw, 25vw" style={{ display: 'block', objectPosition: 'var(--image-component-focal-point)' as any, objectFit: 'var(--image-component-object-fit)' as any } as any} loading="lazy" />
              ...
              <div className="fe-block fe-block-a705943738e3a5a1af83" id="yui_3_17_2_1_1771487219329_110">
                  ...
                  <div className="sqs-block-content" style={{ height: '100%', width: '100%' }}>
                    ...
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default sqs-narrow-width animation-loaded" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{ overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', height: '100%', width: '386px' }} data-sqsp-image-block-image-container="">

                          <div className="js-content-mode-element content-fit">
                            
                            <Image src="/image-11.webp" alt="" width={1000} height={1000} sizes="(max-width: 640px) 100vw, (max-width: 767px) 62.5vw, 32.29vw" style={{ display: 'block', objectPosition: 'var(--image-component-focal-point)' as any, objectFit: 'var(--image-component-object-fit)' as any } as any} loading="lazy" />
              ...
              <div className="fe-block fe-block-97a7dc9199a5474f666d">
                <div className="sqs-block button-block sqs-block-button" data-block-type="53" id="block-97a7dc9199a5474f666d">
                  <div className="sqs-block-content">
                    ...
                    <div className="sqs-block-button-container sqs-block-button-container--center" data-sqsp-block-button-container="" data-animation-role="button" data-alignment="center" data-button-size="medium" data-button-type="primary">
                      <a className="sqs-block-button-element--medium sqs-block-button-element sqs-button-element--primary" href="https://www.slicepizzaworks.com/menu" data-sqsp-block-button="">
                        VIEW MENU
                      </a>
                    </div>

                ...
                <div className="sqs-block marquee-block sqs-block-marquee" data-blend-mode="NORMAL" data-block-type="70" data-sqsp-block="scrolling" id="block-4ec6f7970b0f5f240202">
                  <div className="sqs-block-content">
                    ...
                    <div className="Marquee" style={{ fontSize: '1.2rem', '--marquee-font-size-value': '1.2' } as any} data-ready="true">
                      ...
                      <div className="Marquee-content" data-animation-direction="left" data-animation-speed="1.0" data-animation-state="running" style={{ animationDuration: '20s' }}>
                        <div className="Marquee-item" style={{ fontSize: '1.2rem' }}>
                          <span className="Marquee-item-content">YOU SAY PIZZA</span>
                        </div>
                        <div className="Marquee-item" style={{ fontSize: '1.2rem' }}>
                          <span className="Marquee-item-content">🍕</span>
                        </div>
                        <div className="Marquee-item" style={{ fontSize: '1.2rem' }}>
                          <span className="Marquee-item-content">WE SAY PIE</span>
                        </div>
                        <div className="Marquee-item" style={{ fontSize: '1.2rem' }}>
                          <span className="Marquee-item-content">🍕</span>
                        </div>
                        <div className="Marquee-item" style={{ fontSize: '1.2rem' }}>
                          <span className="Marquee-item-content">IT'S ALL YUM</span>
                        </div>
                        <div className="Marquee-item" style={{ fontSize: '1.2rem' }}>
                          <span className="Marquee-item-content">🍕</span>
                        </div>

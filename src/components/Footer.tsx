  ...
  return (
    <footer className="sections" id="footer-sections" data-footer-sections="">
      <section data-test="page-section" data-section-theme="bright" className="page-section has-section-divider full-bleed-section layout-engine-section background-width--full-bleed section-height--custom content-width--wide horizontal-alignment--center vertical-alignment--middle bright" data-animation="none" style={{ minHeight: '7vh' } as any}>
        <div className="section-border" style={{ clipPath: 'url(#section-divider-658f00a2f272f378735b0764)' } as any}>
          <div className="section-background">
          </div>
        </div>
        <div className="content-wrapper" style={{ paddingTop: 'calc(7vmax / 10)', paddingBottom: 'calc(7vmax / 10)' } as any}>
          <div className="content">
            <div>
              
              <div className="fluid-engine fe-658f00a2f272f378735b0763">
                <div className="fe-block fe-block-78d5c65ecdc06f397a7d" style={{ mixBlendMode: 'normal' } as any}>
                      ...
                      <div className="Marquee" style={{ fontSize: '1.2rem', '--marquee-font-size-value': '1.2' } as any} data-ready="true">
                        <div className="Marquee-display ">
                          ...
                          <h1 style={{ fontSize: '1.2rem', '--marquee-font-size-value': '1.2' } as any}>
                            ...
                            <span className="v6-visually-hidden" id="ariaLabel78d5c65ecdc06f397a7d">
        ...
        <div className="section-divider-display" style={{ '--stroke-thickness': '2px', '--stroke-dasharray': '0', '--stroke-linecap': 'square', '--section-divider-stroke-color': 'hsla(var(--white-hsl),1)' } as any}>
          ...
          <svg className="section-divider-svg-stroke" viewBox="0 0 1 1" preserveAspectRatio="none">
            <path className="section-divider-stroke" d="M-100,0.5 L-100,1.5 M0,1 L1,1" vectorEffect="non-scaling-stroke"></path>
          </svg>
        </div>
      </section>
    <style jsx>{`

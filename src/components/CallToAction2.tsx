...
export default function CallToAction2() {
  return (
    <section data-test="page-section" data-section-theme="white" className="page-section full-bleed-section layout-engine-section background-width--full-bleed section-height--medium content-width--wide horizontal-alignment--center vertical-alignment--middle has-background white" data-animation="none" id="yui_3_17_2_1_1771706185849_205">
      ...
      <div className="content-wrapper" style={{}} id="yui_3_17_2_1_1771706185849_204">
        <div className="content" id="yui_3_17_2_1_1771706185849_203">
          <div id="yui_3_17_2_1_1771706185849_202">
            
            <div className="fluid-engine fe-6596f6510337c27da4828ba5" id="yui_3_17_2_1_1771706185849_201">
              <div className="fe-block fe-block-1ef399867fe80a1a9b64" id="yui_3_17_2_1_1771706185849_200">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-aspect-ratio="100" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-1ef399867fe80a1a9b64">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771706185849_199" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default" data-component-id="1ef399867fe80a1a9b64" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="true" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771706185849_198">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771706185849_197">
                        <div className="fluid-image-container sqs-image-content js-image-container" data-shape-mask="eight-sided-shield" style={{ overflow: 'hidden', clipPath: 'url("#1ef399867fe80a1a9b64")', width: '100%', height: '657px' }} data-sqsp-image-block-image-container="" id="yui_3_17_2_1_1771706185849_196">
                          <div className="js-content-mode-element content-fill" id="yui_3_17_2_1_1771706185849_193">
                            <img 
                              data-stretch="false" 
                              ...
                              height="3598" 
                              sizes="100vw" 
                              style={{ display: 'block', objectPosition: 'var(--image-component-focal-point)', objectFit: 'var(--image-component-object-fit)' } as any} 
              ...
              <div className="fe-block fe-block-yui_3_17_2_1_1706211787573_32812">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-button button-block" data-block-type="1330" data-definition-name="website.components.button" data-sqsp-block="button" id="block-yui_3_17_2_1_1706211787573_32812">
                  <div className="sqs-block-content">
                    <div className="button-component-root button-block-outer-wrapper design-layout-button-stretch combination-animation-site-default individual-animation-site-default" data-component-id="yui_3_17_2_1_1706211787573_32812" data-test="button-block-wrapper">
                      <div className="button-component-inner-container button-component-center-aligned">
                        <a className="btn btn--border btn--accent" href="/online-ordering" data-sqsp-button-element="">GIFT CARDS</a>
                      </div>
                    </div>
                  </div>
                </div>

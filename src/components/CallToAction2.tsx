...
export default function CallToAction2() {
  return (
    <section data-test="page-section" data-section-theme="white" className="page-section full-bleed-section layout-engine-section background-width--full-bleed section-height--medium content-width--wide horizontal-alignment--center vertical-alignment--middle has-background white" data-animation="none" id="yui_3_17_2_1_1771527860063_205">
      ...
      <div className="content-wrapper" style={{}} id="yui_3_17_2_1_1771527860063_204">
        <div className="content" id="yui_3_17_2_1_1771527860063_203">
          <div id="yui_3_17_2_1_1771527860063_202">
            
            <div className="fluid-engine fe-6596f6510337c27da4828ba5" id="yui_3_17_2_1_1771527860063_201">
              <div className="fe-block fe-block-1ef399867fe80a1a9b64" id="yui_3_17_2_1_1771527860063_200">
                ...
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-button button-block">
                  <div className="sqs-block-content">
                    <div className="sqs-block-button-container sqs-block-button-container--center" data-animation-role="button" data-alignment="center" data-button-size="medium" data-button-type="primary">
                      <a href="/gift-cards" className="sqs-block-button-element sqs-block-button-element--medium sqs-button-element--primary sqs-block-button-element--has-focus" target="">
                        PURCHASE GIFT CARDS
                      </a>
                    </div>
                  </div>

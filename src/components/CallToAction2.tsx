...
export default function CallToAction2() {
  return (
    <section data-test="page-section" data-section-theme="bright" className="page-section has-section-divider full-bleed-section layout-engine-section background-width--full-bleed section-height--medium content-width--wide horizontal-alignment--center vertical-alignment--middle bright" data-animation="none" data-fluid-engine-section="" id="yui_3_17_2_1_1771488503913_180">
      <div className="section-border" style={{ clipPath: 'url(#section-divider-658f2bce80842075444608af)' } as any}>
        <div className="section-background">
        </div>
      </div>
      <div className="content-wrapper" id="yui_3_17_2_1_1771488503913_179">
        <div className="content" id="yui_3_17_2_1_1771488503913_178">
          <div data-fluid-engine="true" id="yui_3_17_2_1_1771488503913_177">
            <style jsx>{`
            ...
            `}</style>
            <div className="fluid-engine fe-658f2bce80842075444608ae" id="yui_3_17_2_1_1771488503913_176">
              <div className="fe-block fe-block-41bcbba421979d3ae030" id="yui_3_17_2_1_1771488503913_175">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-41bcbba421979d3ae030">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771488503913_174" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default" data-component-id="41bcbba421979d3ae030" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771488503913_173">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771488503913_172">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{ overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', width: '100%', height: '524.081px' }} data-sqsp-image-block-image-container="" id="yui_3_17_2_1_1771488503913_171">
                          <div className="js-content-mode-element content-fit" id="yui_3_17_2_1_1771488503913_170">
              ...
              <div className="fe-block fe-block-f7a4c0cfa5d9377898d0" id="yui_3_17_2_1_1771488503913_189">
                  ...
                  <div className="sqs-block-content" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default" data-component-id="f7a4c0cfa5d9377898d0" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{ overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', width: '100%', height: '329.1px' }} data-sqsp-image-block-image-container="">
                          <div className="js-content-mode-element content-fit">
                            <Image data-stretch="false" data-src="https://images.squarespace-cdn.com/content/v1/64b164dfe7e65e1a8cd14aff/bf726a3c-3b1f-4859-bc21-a2b0329b68d8/AHS+Wordmark+-+Color+Scheme+1.png" data-image="https://images.squarespace-cdn.com/content/v1/64b164dfe7e65e1a8cd14aff/bf726a3c-3b1f-4859-bc21-a2b0329b68d8/AHS+Wordmark+-+Color+Scheme+1.png" data-image-dimensions="842x330" data-image-focal-point="0.5,0.5" data-sqsp-image-block-image="" alt="" data-licensed-asset-preview="false" data-load="false" src="https://images.squarespace-cdn.com/content/v1/64b164dfe7e65e1a8cd14aff/bf726a3c-3b1f-4859-bc21-a2b0329b68d8/AHS+Wordmark+-+Color+Scheme+1.png" width={842} height={330} sizes="(max-width: 640px) 100vw, (max-width: 767px) 100vw, 26.666666666666668vw" style={{ display: 'block', objectPosition: 'var(--image-component-focal-point)' as any, objectFit: 'var(--image-component-object-fit)' as any } as any} loading="lazy" />
                            <div className="fluidImageOverlay"></div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="sqs-block-content">
                    <div className="sqs-html-content">
                      <p className="" style={{ whiteSpace: 'pre-wrap' }}>
                        Asheville Hot Spots is more than a local delivery service – we're your neighbors, connecting people with the food they love. Born and raised in Western North Carolina, we understand what makes our community special. From intimate date nights to feeding the whole crew, AHS brings Asheville's incredible culinary scene directly to your table.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="fe-block fe-block-yui_3_17_2_1_1703881549797_13556">
                <div className="sqs-block html-block sqs-block-html" data-block-type="2" data-sqsp-block="text" id="block-yui_3_17_2_1_1703881549797_13556">
                  <div className="sqs-block-content">
                    <div className="sqs-html-content">
                      <p className="" style={{ whiteSpace: 'pre-wrap', textAlign: 'center' }}>

...
export default function CallToAction2() {
  return (
    ...
    white" data-animation="none" data-fluid-engine-section="" id="yui_3_17_2_1_1771485953910_205">
      ...
      <div className="content-wrapper" style={{}} id="yui_3_17_2_1_1771485953910_204">
        <div className="content" id="yui_3_17_2_1_1771485953910_203">
          <div data-fluid-engine="true" id="yui_3_17_2_1_1771485953910_202">
            <style jsx>{`
            ...
            `}</style>
            <div className="fluid-engine fe-6596f6510337c27da4828ba5" id="yui_3_17_2_1_1771485953910_201">
              <div className="fe-block fe-block-1ef399867fe80a1a9b64" id="yui_3_17_2_1_1771485953910_200">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-aspect-ratio="100" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-1ef399867fe80a1a9b64">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771485953910_199" style={{ height: '100%', width: '100%' }}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default" data-component-id="1ef399867fe80a1a9b64" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="true" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771485953910_198">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771485953910_197">
                        <div className="fluid-image-container sqs-image-content js-image-container" data-shape-mask="eight-sided-shield" style={{ overflow: 'hidden', clipPath: 'url("#1ef399867fe80a1a9b64")', width: '100%', height: '657px' }} data-sqsp-image-block-image-container="" id="yui_3_17_2_1_1771485953910_196">
                          <div className="js-content-mode-element content-fill" id="yui_3_17_2_1_1771485953910_193">
                            <img
                              data-stretch="false"
                              data-src="https://images.squarespace-cdn.com/content/v1/64b164dfe7e65e1a8cd14aff/385cb7e5-20b6-4330-83c4-e09263d49567/061222_SPG_Ghirardelli_EDITED_MelatiCitrawireja_-53+%281%29+%281%29.jpg"
                              data-image="https://images.squarespace-cdn.com/content/v1/64b164dfe7e65e1a8cd14aff/385cb7e5-20b6-4330-83c4-e09263d49567/061222_SPG_Ghirardelli_EDITED_MelatiCitrawireja_-53+%281%29+%281%29.jpg"
                              data-image-dimensions="5397x3598"
              ...
              <div className="fe-block fe-block-yui_3_17_2_1_1706211787573_32812">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-button button-block" data-block-type="53" data-sqsp-block="button" id="block-yui_3_17_2_1_1706211787573_32812">
                  <div className="sqs-block-content">
                    <div className="sqs-block-button-container sqs-block-button-container--center" data-animation-role="button" data-alignment="center" data-button-size="large" data-button-type="primary">
                      <a href="/gift-cards" className="sqs-block-button-element--large sqs-button-element--primary sqs-block-button-element" data-initialized="true">
                        Order Gift Cards
                      </a>
                    </div>
                  </div>

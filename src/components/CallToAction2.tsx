...
export default function CallToAction2() {
  return (
    <section data-test="page-section" data-section-theme="white" className="page-section full-bleed-section layout-engine-section background-width--full-bleed section-height--medium content-width--wide horizontal-alignment--center vertical-alignment--middle has-background white" data-animation="none" id="yui_3_17_2_1_1771649929298_205">
      <div className="section-border">
        <div className="section-background">
          <img alt="" data-src="/image-5.webp" data-image="/image-5.webp" data-image-dimensions="2532x1404" data-image-focal-point="0.5,0.5" data-load="false" src="/image-5.webp" width="2532" height="1404" sizes="(max-width: 799px) 200vw, 100vw" style={{display: 'block', objectPosition: '50% 50%'}} loading="lazy" decoding="async" data-loader="sqs" />
          <div className="section-background-overlay" style={{opacity: 0.15}}></div>
        </div>
      </div>
      <div className="content-wrapper" style={{}} id="yui_3_17_2_1_1771649929298_204">
        <div className="content" id="yui_3_17_2_1_1771649929298_203">
          <div id="yui_3_17_2_1_1771649929298_202">
            
            <div className="fluid-engine fe-6596f6510337c27da4828ba5" id="yui_3_17_2_1_1771649929298_201">
              <div className="fe-block fe-block-1ef399867fe80a1a9b64" id="yui_3_17_2_1_1771649929298_200">
              ...
              <div className="fe-block fe-block-yui_3_17_2_1_1706211787573_32812">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-button button-block" data-block-type="1328" data-definition-name="website.components.button" data-sqsp-block="button" id="block-yui_3_17_2_1_1706211787573_32812">
                  <div className="sqs-block-content">
                    <div className="button-component-root design-layout-stack combination-animation-site-default individual-animation-site-default animation-loaded" data-component-id="yui_3_17_2_1_1706211787573_32812" data-test="button-block-outer-wrapper">
                      <div className="button-component-link-wrapper">
                        <a className="button-component-link sqs-block-button-element--medium sqs-button-element--primary" href="/" data-animation-role="button" data-test="button-block-link">
                          <div className="button-component-label">
                            PURCHASE GIFT CARD
                          </div>
                        </a>
                      </div>

...
export default function Specials() {
  return (
    <section data-test="page-section" data-section-theme="white" className="page-section full-bleed-section layout-engine-section background-width--full-bleed section-height--medium content-width--wide horizontal-alignment--center vertical-alignment--middle has-background white" data-animation="none" id="yui_3_17_2_1_1771614840784_124">
      <div className="section-border">
        <div className="section-background">
          <img alt="" data-src="/image-5.webp" data-image="/image-5.webp" data-image-dimensions="2532x1404" data-image-focal-point="0.3847645429362881,0.0" data-load="false" src="/image-5.webp" width="2532" height="1404" sizes="(max-width: 799px) 200vw, 100vw" style={{display:'block', objectPosition: '38.47645429362881% 0%'} as any} srcSet="/image-5.webp?format=100w 100w, /image-5.webp?format=300w 300w, /image-5.webp?format=500w 500w, /image-5.webp?format=750w 750w, /image-5.webp?format=1000w 1000w, /image-5.webp?format=1500w 1500w, /image-5.webp?format=2500w 2500w" loading="lazy" decoding="async" data-loader="sqs" />
          <div className="section-background-overlay" style={{opacity: '0.15'}}></div>
        </div>
      </div>
      <div className="content-wrapper" style={{}} id="yui_3_17_2_1_1771614840784_123">
        <div className="content" id="yui_3_17_2_1_1771614840784_122">
          <div id="yui_3_17_2_1_1771614840784_121">
            
            <div className="fluid-engine fe-6930a01a962bd378892a6ff4" id="yui_3_17_2_1_1771614840784_120">
              ...
              <div className="fe-block fe-block-yui_3_17_2_1_1764794358184_9218">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-button button-block" data-block-type="1337" data-definition-name="website.components.button" data-sqsp-block="button" id="block-yui_3_17_2_1_1764794358184_9218">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771614840784_229">
                    <div className="sqs-block-button-container  sqs-block-button-container--center sqs-stretched" data-animation-role="button" data-button-size="medium" data-button-type="primary" id="yui_3_17_2_1_1771614840784_228"> 
              ...
              <div className="fe-block fe-block-d45d97061647687db19c" id="yui_3_17_2_1_1771614840784_119">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-d45d97061647687db19c">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771614840784_118" style={{height: '100%', width: '100%'}}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default sqs-narrow-width" data-component-id="d45d97061647687db19c" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771614840784_117">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771614840784_116">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', width: '100%', height: '101.188px'}} id="yui_3_17_2_1_1771614840784_115">
                          <div className="js-content-mode-element content-fit" id="yui_3_17_2_1_1771614840784_114">
                  ...
                  <div className="sqs-block-content" style={{height: '100%', width: '100%'}}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default sqs-narrow-width" data-component-id="yui_3_17_2_1_1764794357165_38882" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', width: '100%', height: '192.84px'}}>
                          <div className="js-content-mode-element content-fit">
                            <Image data-stretch="false" data-src="/image-9.webp" data-image="/image-9.webp" data-image-dimensions="2250x1190" data-image-focal-point="0.5,0.5" alt="" data-licensed-asset-preview="false" data-load="false" src="/image-9.webp" width={2250} height={1190} sizes="(max-width: 640px) 100vw, (max-width: 767px) 85vw, 50vw" />
                          </div>
                        </div>
                      </div>
                    </div>

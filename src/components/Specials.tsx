...
export default function Specials() {
  return (
    ...
    white" data-animation="none" data-fluid-engine-section="" id="yui_3_17_2_1_1771487219329_124">
      ...
      <div className="content-wrapper" style={{}} id="yui_3_17_2_1_1771487219329_123">
        <div className="content" id="yui_3_17_2_1_1771487219329_122">
          <div data-fluid-engine="true" id="yui_3_17_2_1_1771487219329_121">
            <style jsx>{`
...
#block-yui_3_17_2_1_1764794358184_9218 {
  --sqs-block-content-flex: 1;
            ...
            `}</style>
            <div className="fluid-engine fe-6930a01a962bd378892a6ff4" id="yui_3_17_2_1_1771487219329_120">
              ...
              <div className="fe-block fe-block-yui_3_17_2_1_1764794358184_9218">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-button button-block" data-block-type="1337" data-definition-name="website.components.button" data-sqsp-block="button" id="block-yui_3_17_2_1_1764794358184_9218">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771487219329_229">
                    <div className="sqs-block-button-container  sqs-block-button-container--center sqs-stretched" data-animation-role="button" data-button-size="medium" data-button-type="primary" id="yui_3_17_2_1_1771487219329_228"> 
              ...
              <div className="fe-block fe-block-d45d97061647687db19c" id="yui_3_17_2_1_1771487219329_119">
                <div className="sqs-block website-component-block sqs-block-website-component sqs-block-image image-block sqs-text-ready" data-block-type="1337" data-definition-name="website.components.imageFluid" data-sqsp-block="image" id="block-d45d97061647687db19c">
                  <div className="sqs-block-content" id="yui_3_17_2_1_1771487219329_118" style={{height: '100%', width: '100%'}}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default sqs-narrow-width" data-component-id="d45d97061647687db19c" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5" id="yui_3_17_2_1_1771487219329_117">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image" id="yui_3_17_2_1_1771487219329_116">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', width: '100%', height: '101.188px'}} data-sqsp-image-block-image-container="" id="yui_3_17_2_1_1771487219329_115">
                          <div className="js-content-mode-element content-fit" id="yui_3_17_2_1_1771487219329_114">
                  ...
                  <div className="sqs-block-content" style={{height: '100%', width: '100%'}}>
                    <div className="fluid-image-component-root image-block-outer-wrapper design-layout-fluid image-position-center combination-animation-site-default individual-animation-site-default sqs-narrow-width" data-component-id="yui_3_17_2_1_1764794357165_38882" data-test="image-block-fluid-outer-wrapper" data-is-image-stretched="false" data-is-mask-applied="false" data-media-focal-point="0.5,0.5">
                      <div className="fluid-image-animation-wrapper sqs-image sqs-block-alignment-wrapper" data-animation-role="image">
                        <div className="fluid-image-container sqs-image-content js-image-container" style={{overflow: 'hidden', maskImage: '-webkit-radial-gradient(center, white, black)', width: '100%', height: '271.2px'}} data-sqsp-image-block-image-container="">
                          <div className="js-content-mode-element content-fit">
                            <Image data-stretch="false" data-src="/image-10.webp" data-image="/image-10.webp" data-image-dimensions="1080x2400" data-image-focal-point="0.5,0.5" data-sqsp-image-block-image="" alt="" data-licensed-asset-preview="false" data-load="false" src="/image-10.webp" width={1080} height={2400} sizes="(max-width: 640px) 100vw, (max-width: 767px) 50vw, 50vw" />
                          </div>
                        </div>
                      </div>
                    </div>
